module UsersHelper
    ...
    def friend_buttons(user)
        ...
        when "friends"
            link_to "Remove Friend", friendships_path(current_user.friendship_relation(user)),
            method: :delete
        when "pending"

            link_to "Cancel Request", friendships_path(current_user.friendship_relation(user)),
             method: :delete
        when "requested"
